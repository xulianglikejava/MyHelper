...
public class 组队魂土 {
    ...
    public void 开始魂土() {
        ...
        try {
            // 读取判断点信息
            ArrayList<int[]> 挑战的坐标 = mouseUtils.FileToArrayList("组队魂土坐标.txt");
    ...
    public void 组队魂土坐标() {
        ...
        try {
            mouseUtils.saveMouseInfo("单人魂土坐标.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void 设置结算坐标() {
        ...
        System.out.println("设置坐标...");
        try {
            mouseUtils.saveMouseInfo("组队魂土坐标.txt");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
